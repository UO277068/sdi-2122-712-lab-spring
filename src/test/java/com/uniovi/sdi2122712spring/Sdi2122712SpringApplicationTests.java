...
import com.uniovi.sdi2122712spring.pageobjects.*;
import com.uniovi.sdi2122712spring.util.SeleniumUtils;
...
class Sdi2122712SpringApplicationTests {

    static String PathFirefox = "C:\\Program Files\\Mozilla Firefox\\firefox.exe";
    //static String Geckodriver = "C:\\Path\\geckodriver-v0.30.0-win64.exe";
    static String Geckodriver = "C:\\Users\\ROBERTO\\Desktop\\Uniovi\\SDI\\sesion05\\PL-SDI-Sesión5-material\\geckodriver-v0.30.0-win64.exe";
    ...
    public void PR04() {
       ...
       // PO_HomeView.checkChangeLanguage(driver, "btnEnglish", "btnSpanish",
        //        PO_Properties.getENGLISH(), PO_Properties.getSPANISH());
    }
...
// Propiedad: Error.signup.dni.length
    ...
    /*
    // Propiedad: Error.signup.surname.length
    @Test
    @Order(9)
    public void PR06C() {
        PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
        PO_SignUpView.fillForm(driver, "99949990B", "pepepe", "", "77777", "77777");
    ...
    */
    ...
    public void PR10() {
        ...
        PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
        //Rellenamos el formulario
        PO_LoginView.fillLoginForm(driver, "99999990A", "23");
    ...
    public void PR12() {
        //Rellenamos el formulario
        PO_LoginView.loginUser(driver, "99999990A", "123456","Notas del usuario");
        //COmprobamos que entramos en la pagina privada de Alumno
        ...
        PO_LoginView.logoutUser(driver,PO_Properties.getSPANISH());
    }
...
//P14. Esta prueba podría encapsularse mejor ...
    ...
    @Order(16)
    public void PR14() {
        //Vamos al formulario de login y Cmmprobamos que entramos en la pagina privada del Profesor
        PO_LoginView.loginUser(driver, "99999993D", "123456","99999993D");
        //Pinchamos en la opción de menú de Notas: //li[contains(@id, 'marks-menu')]/a
        PO_PrivateView.checkViewAndClick(driver, "free", "//li[contains(@id, 'marks-menu')]/a",0);
        //Esperamos a que aparezca la opción de añadir nota: //a[contains(@href, 'mark/add')] y Pinchamos en agregar Nota.
        PO_PrivateView.checkViewAndClick(driver, "free", "//a[contains(@href, 'mark/add')]",0);

        //Ahora vamos a rellenar la nota. //option[contains(@value, '4')]
        String checkText = "Nota Nueva 1";
        PO_PrivateView.fillFormAddMark(driver, 3, checkText, "8");
        //Esperamos a que se muestren los enlaces de paginación de la lista de notas y nos vamos a la ultima pagina
    ...
    @Order(17)
    public void PR15() {
        //Vamos al formulario de login. y  //Comprobamos que entramos en la página privada del Profesor
        PO_LoginView.loginUser(driver, "99999993D", "123456","99999993D");
        ...
        PO_PrivateView.checkViewAndClick(driver, "free", "//a[contains(@href, 'mark/list')]",0);

        //Esperamos a que se muestren los enlaces de paginación la lista de notas y nos vamos a la ultima pagina
        PO_PrivateView.checkViewAndClick(driver, "free", "//a[contains(@class, 'page-link')]",3);

        //Esperamos a que aparezca la Nueva nota en la última página
        //Y Pinchamos en el enlace de borrado de la Nota "Nota Nueva 1"
        PO_PrivateView.checkViewAndClick(driver, "free", "//td[contains(text(), 'Nota Nueva 1')]/following-sibling::*/a[contains(@href, 'mark/delete')]",0);
